...
if ($_SESSION['role'] !== "admin") {
    echo "<h2 style='text-align:center; color:red;'>Access Denied! Only Admin Can View Cart Data.</h2>";
    exit();
}

// Fetch cart data from the database
$sql = "SELECT cart.*, users.name, users.email,users.phone
        FROM cart 
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <h2 class=" head text-center" style="margin-top: 5%;">All Cart Data</h2>
                ...
                <table class="table table-bordered table-hover mt-4">
                    ...
                    <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr><td colspan='8' class='text-center'>No cart data found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
